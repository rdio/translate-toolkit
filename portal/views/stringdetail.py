...
Autogenerated by CHEETAH: The Python-Powered Template Engine
 ...
 Generation time: Wed Jul 14 18:33:06 2004
   ...
   Source file last modified: Wed Jul 14 18:33:01 2004
"""
...
''')
            ...
            write(filter(VFN(transl,"raw",True), rawExpr='$transl.raw')) # from line 27, col 57.
            write('</td>\n            </tgr>\n')
        write('        </tr>\n        <tr>\n            <td align="right">Accelerator : </td><td>')
        write(filter(VFN(transl,"getAccelerator",False)(), rawExpr='$transl.getAccelerator()')) # from line 32, col 54.
        write('''</td>
        </tr>
        <tr>
            <td align="right">Stripped string : </td><td>''')
        write(filter(VFN(transl,"getStripped",False)(), rawExpr='$transl.getStripped()')) # from line 35, col 58.
        write('''</td>
        </tr>
        <tr>
...
''')
        ...
        write('">')
        write(filter(VFS(SL + [globals(), __builtin__],"original.file.project.name",True), rawExpr='$original.file.project.name')) # from line 50, col 85.
        write(' (')
        write(filter(VFS(SL + [globals(), __builtin__],"original.file.project.version",True), rawExpr='$original.file.project.version')) # from line 50, col 114.
        ...
        write('">')
        write(filter(VFS(SL + [globals(), __builtin__],"original.file.name",True), rawExpr='$original.file.name')) # from line 51, col 71.
        write('</a></small>>\n        <small><u>')
...
''')
        ...
        write(filter(VFS(SL + [globals(), __builtin__],"original.translator_comment",True), rawExpr='$original.translator_comment')) # from line 64, col 65.
        write('''</td>
            </tr>
            <tr>
                <td align="right">Comment : </td><td>''')
        write(filter(VFS(SL + [globals(), __builtin__],"original.comment",True), rawExpr='$original.comment')) # from line 67, col 54.
        write('''</td>
            </tr>
            <tr>
                <td align="right">Raw string : </td><td>''')
        write(filter(VFS(SL + [globals(), __builtin__],"original.raw",True), rawExpr='$original.raw')) # from line 70, col 57.
        write('''</td>
            </tr>
            <tr>
                <td align="right">Accelerator : </td><td>''')
        write(filter(VFN(VFS(SL + [globals(), __builtin__],"original",True),"getAccelerator",False)(), rawExpr='$original.getAccelerator()')) # from line 73, col 58.
        write('''</td>
            </tr>
            <tr>
                <td align="right">Stripped string : </td><td>''')
        write(filter(VFN(VFS(SL + [globals(), __builtin__],"original",True),"getStripped",False)(), rawExpr='$original.getStripped()')) # from line 76, col 62.
        write('''</td>
            </tr>
            <tr>
                <td align="right">Number of words : </td><td>''')
