...
Autogenerated by CHEETAH: The Python-Powered Template Engine
 ...
 Generation time: Fri Jun 18 10:15:35 2004
   Source file: views/filedetail.tmpl
   Source file last modified: Fri Jun 18 02:36:56 2004
"""

__CHEETAH_genTime__ = 'Fri Jun 18 10:15:35 2004'
__CHEETAH_src__ = 'views/filedetail.tmpl'
...
class filedetail(Template):
    ...
    <body>
        <small><a href="index?view=filelist">Home</a></small>>
        <small><u>''')
        write(filter(VFS(SL + [globals(), __builtin__],"file.name",True), rawExpr='$file.name')) # from line 7, col 19.
        write('''</u></small>        
        <h1>File details</h1>
        <hr/>
        <h2>Properties:</h2>
        ...
        write(filter(VFS(SL + [globals(), __builtin__],"file.name",True), rawExpr='$file.name')) # from line 12, col 51.
        write('''</td></tr>
        </table>
        <hr/>
        <h2>Strings:</h2>
''')
        for original in VFN(VFS(SL + [globals(), __builtin__],"file",True),"getOriginals",False)():
            ...
            write(filter(VFN(original,"id",True), rawExpr='$original.id')) # from line 18, col 58.
            write('">')
            write(filter(displayname[:20], rawExpr='$displayname[:20]')) # from line 18, col 72.
            write(' ...</a></p>\n')
        write('    </body>\n</html>\n')
